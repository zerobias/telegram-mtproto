...
// Convert a String to a Buffer using TypeObject serialization
function string2Buffer(str, bufferLength) {
    return TypeObject.stringValue2Buffer(str, bufferLength);
}

// Convert a Buffer to a String using TypeObject deserialization
function buffer2String(buffer) {
    return TypeObject.buffer2StringValue(buffer);
}

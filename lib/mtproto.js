...
TypeBuilder.buildTypes(mtTlSchema.constructors, null, type);
...
TypeBuilder.buildTypes(mtTlSchema.methods, null, service, true);
TypeBuilder.buildTypes(mtApiTlSchema.methods, null, service, true);

declare module 'localforage' {
  declare export interface LocalForageOptions {
  ...
  declare export interface LocalForageDbMethods {
  ...
  declare export interface LocalForageDriverSupportFunc {
    (): Promise < boolean >
  }
  declare export type LocalForageDriver = {
    _driver: string,
    _initStorage(options: LocalForageOptions): void,
    _support ? : boolean | LocalForageDriverSupportFunc
  } & LocalForageDbMethods
  declare export interface LocalForageSerializer {
    serialize < T > (
  ...
  declare export type LocalForage = {
    LOCALSTORAGE: string,
    WEBSQL: string,
    INDEXEDDB: string,
   ...
   * @param
   */
  declare export function createInstance(options: LocalForageOptions): LocalForage
  declare export default LocalForage
}
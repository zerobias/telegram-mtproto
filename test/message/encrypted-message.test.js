...
describe('EncryptedMessage', function() {
    ...
    describe('#init()', function() {
        it('should return an instance', function(done) {
            ...
            msg = new EncryptedMessage({message: innerMessage, authKey: authKey});
            msg.should.have.properties({innerMessage: innerMessage, authKey: authKey});
    ...
    describe('#serialize()', function () {
        it('should serialize the msg', function (done) {
            var msg = new EncryptedMessage({
                message: new EncryptedMessage.InnerMessage(innerModel),
                authKey: authKey});
            var buffer = msg.serialize();
            buffer.should.be.ok;
    ...
    describe('#deserialize()', function () {
        it('should deserialize the msg', function (done) {
            ...
            var msg = decrypted.innerMessage;
            msg.should.be.an.instanceof(EncryptedMessage.InnerMessage);
            msg.should.have.properties({
                server_salt: '0xfce2ec8fa401b366',
                session_id: '0x77907373a54aba77'

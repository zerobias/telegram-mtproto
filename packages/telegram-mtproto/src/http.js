...
import { Right, Left, type Apropos } from 'apropos'
...
const postPromise = (url: string, data: Int32Array) => httpClient.post(url, data, requestOptions)

export type Send = Encased2<string, Int32Array, AxiosXHR<ArrayBuffer>, AxiosError<ArrayBuffer>>
export const send: Send = encaseP2(postPromise)

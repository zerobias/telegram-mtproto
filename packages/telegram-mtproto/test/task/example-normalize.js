...
const fullConfig = {
  ...
  authKeyUint8,
  thisSessionID: [104, 253, 6, 5, 166, 213, 190, 141],
  prevSessionID: void 0,
  getMsgById({ req_msg_id }: { req_msg_id: string }) {
    return threadState.get(req_msg_id)
  },
}
...
const serverSalt = [131, 212, 20, 140, 103, 98, 135, 139]
